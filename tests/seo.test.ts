...
test("En Vercel utiliza el dominio público aunque SITE_URL todavía no esté definido", async () => {
  ...
  expect(result.openGraph?.images).toEqual([
    {
      url: "https://arcangel-test.vercel.app/brand/arcangel-social.jpg",
      alt: "Inicio",
      width: 1200,
      height: 630,
      type: "image/jpeg",
  ...
  expect(result.twitter?.images).toEqual([
    "https://arcangel-test.vercel.app/brand/arcangel-social.jpg",
  ]);
});
