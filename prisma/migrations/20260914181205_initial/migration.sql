-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'COMPLETED', 'INQUIRY_ONLY', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PurchaseType" AS ENUM ('RETAIL', 'WHOLESALE');
...
CREATE TABLE "Cart" (
    ...
    "purchaseType" "PurchaseType" NOT NULL DEFAULT 'RETAIL',
