...
export default function Wholesale({
  ...
  return (
    <section
      ref={animationRef}
      className="wholesaleContent"
      aria-labelledby="wholesaleTitle"
    >
      <div className="wholesaleInner">
        <h2 id="wholesaleTitle" className="wholesaleTitle">
          {content.wholesaleTitle}
        </h2>
        <p className="wholesaleDescription">{content.wholesaleDescription}</p>
        <Link href="/mayoristas" className="wholesaleButton">
          {content.wholesaleButton}
        </Link>
      </div>
    </section>
  );
