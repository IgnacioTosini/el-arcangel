  ...
  return (
    ...
    >
      ...
      {wholesale && (
        <>
          ...
          <input
            ...
            maxLength={160}
            placeholder="Comercio o emprendimiento"
            value={value.business}
            onChange={(event) =>
              onChange({ ...value, business: event.target.value })
            }
          />
        </>
      )}
      ...
      <textarea
        ...
        rows={4}
        maxLength={2000}
        placeholder="Aromas preferidos, fecha en que lo necesitás, etc."
        value={value.comment}
        onChange={(event) =>
