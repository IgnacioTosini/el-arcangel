...
export default function Local() {
  ...
  return (
    <section
      ref={animationRef}
      className="localContent"
      aria-labelledby="localTitle"
    >
      <h1 id="localTitle" className="localTitle">
        El local
      </h1>
      <p className="localDescription">
        {settings.name} es una santería y regalería con venta por mayor y menor:
        sahumerios, portasahumerios, imágenes religiosas, budas y figuras
        decorativas.
      </p>
