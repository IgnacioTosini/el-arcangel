  ...
  return (
    ...
    >
      <div className="navbarInner">
        ...
        <div
          id="navbarMenu"
          className={`navbarMenu${isMenuOpen ? " navbarMenuOpen" : ""}`}
        >
          <nav className="navbarLinks" aria-label="Navegación principal">
            <Link href="/catalogo" className="navbarLink" onClick={closeMenu}>
              Catálogo
            </Link>
            <Link href="/mayoristas" className="navbarLink" onClick={closeMenu}>
              Mayoristas
            </Link>
            <Link href="/contacto" className="navbarLink" onClick={closeMenu}>
              El local
            </Link>
          </nav>
          <div className="navbarSearch">
            <ProductSearch onNavigate={closeMenu} />
          </div>
        </div>
        ...
        <Link
          ...
          onClick={closeMenu}
          aria-label={
            hasWholesaleSession ? "Mi cuenta mayorista" : "Acceso mayorista"
          }
          title={
            hasWholesaleSession ? "Mi cuenta mayorista" : "Acceso mayorista"
          }
        ...
        <Link
          href="/mi-consulta"
          className="navbarConsultation"
          onClick={closeMenu}
        >
          <span>Mi consulta</span>
          <span
            ref={countRef}
            className="navbarCount"
            aria-label={`${itemCount} artículos`}
          >
            {itemCount}
          </span>
        </Link>
