        ...
        <footer ref={animationRef} className="footerContent">
            <div className="footerInner">
                <div className="footerBrand">
                    ...
                    <p className="footerDescription">{readHomeContent(settings.homeContent).footerDescription}</p>
                </div>
                ...
                <div className="footerContact">
                    ...
                    {settings.whatsapp && <p className="footerDescription"><a href={`https://wa.me/${settings.whatsapp}`} target="_blank" rel="noopener noreferrer">WhatsApp +{settings.whatsapp}</a></p>}
                    {settings.address && <p className="footerDescription">{settings.address}</p>}
                    {settings.hours && <p className="footerDescription">{settings.hours}</p>}
                </div>
            </div>
