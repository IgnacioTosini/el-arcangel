    ...
    <main className="adminLoginContent">
      ...
      <section className="adminLoginCard" aria-labelledby="adminLoginTitle">
        ...
        <p className="adminLoginDescription">
          Ingresá para administrar tus productos, categorías y consultas.
        </p>
        <form action={action}>
          ...
          <div className="adminLoginPassword">
            <input
              ...
              aria-describedby={state.error ? "adminLoginError" : undefined}
            />
            <button
              type="button"
          ...
          <p id="adminLoginError" className="adminLoginError" role="alert">
            {state.error}
          </p>
          <button className="adminLoginSubmit" type="submit" disabled={pending}>
      ...
      <Link href="/" className="adminLoginBack">
        ← Volver al sitio
      </Link>
    </main>
  );
